...
<template>
  ...
  >
    ...
    <p class="py-[30px]">
      ...
      accompagnerons dans la démarche de mieux comprendre vos clients en ligne,
      pour mieux les attirer puis leur faire passer les messages souhaités ou
      acheter vos produits !
    </p>
    <img class="col-span-2" src="/images/hero.png" alt="hero image" />
  </section>

  <section class="">
    <div class="font-poppins mt-20 flex flex-col items-center w-full">
      <h2 class="text-paragraph">POURQUOI NOUS CHOISIR</h2>
      <h1 class="text-title text-[40px] font-bold mb-[58px]">
        Un portefeuille client diversifié
      </h1>
    </div>
    <div class="flex flex-col items-center w-full overflow-x-auto mb-[30px]">
  ...
  <section>
    <div class="font-poppins mt-20 flex flex-col items-center w-full">
      <h2 class="text-paragraph">TÉMOIGNAGES</h2>
      <h1 class="text-title text-[40px] font-bold mb-[58px]">
